    ...
    <header>
      <div className={styles.headerMain}>
        ...
        <img className={styles.logo} src={logo} alt="Logo"></img>
          ...
          <NavLink to={"/categories"} className={styles.grnButton}>
            Catalog
          </NavLink>
        </div>
        <nav className={styles.headerListWrapper}>
          <ul className={styles.headerList}>
            ...
            <li>
              <HashLink smooth to="/products" state="all">
                All products
              </HashLink>
            </li>
            <li>
              <HashLink smooth to="/products" state="sale">
                All sales
              </HashLink>
            </li>
          </ul>
